            ...
            <div>
              ...
              <p>
                {paidPublishingEnabled
                  ...
                  : "현재 제출 버전은 템플릿 선택, 초안 작성, 미리보기와 사진 최대 10장이 포함된 공개 링크 발행을 무료로 제공합니다."}
              </p>
            </div>
            <div>
              <h2 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: 12 }}>지도와 장소 안내</h2>
              <p>도로명주소를 확인하면 카카오 정적 지도가 표시되고, 카카오맵과 네이버지도 검색 링크도 함께 제공됩니다. 지도 미리보기 설정이 없어도 외부 길찾기 링크는 사용할 수 있습니다.</p>
            </div>
          </div>
        </section>
      </div>
