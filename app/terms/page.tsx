      ...
      <div className="app-page-offset">
        <section style={{ maxWidth: 760, margin: "0 auto", padding: "100px 20px 80px" }}>
          ...
          <div style={{ color: "#444", fontSize: "0.92rem", lineHeight: 1.8 }}>
            ...
            <p style={{ marginBottom: 24 }}>
              템플릿 선택, 초안 작성, 미리보기, 사용자 사진 업로드, 공개 링크 발행은 무료로
              제공됩니다. 추후 별도 유료 기능을 제공하는 경우 서비스 화면에서 이용 범위와
              금액을 사전에 안내합니다.
            </p>
            ...
            <p style={{ marginBottom: 24 }}>
              현재 제공 기능은 무료이므로 별도 환불 절차가 발생하지 않습니다. 서비스 내
              오류로 초대장 발행이나 공개 링크 이용에 문제가 발생한 경우 지원 페이지를 통해
              확인을 요청할 수 있습니다.
            </p>
