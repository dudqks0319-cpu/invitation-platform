...
const expectedCurrentCandidate = {
  ...
  sourceCommit: "856e7227d92a2ac7ddf5bc6a49726721d17685dd",
  displayName: "오삼오삼"
};
...
console.log("- Candidate Verdict: local clean PASS; Build 69 source and evidence are bound, while EAS/ASC upload count remains 0.");
console.log("- Device Verdict: the installed development Build 69 is not production/TestFlight provenance.");
console.log("- Required follow-up: keep profile, device, EAS, TestFlight, App Store, staging, and Production actions separately gated.");
