...
const bundledTemplatePreviewSource: Record<BundledTemplatePreviewId, ImageSourcePropType> = {
  ...
  "wedding-photo-minimal": require("../assets/template-previews/generated/wedding/wedding-photo-minimal.png"),
  "wedding-blush-petal": require("../assets/template-previews/generated/wedding/wedding-blush-petal.png"),
  "wedding-traditional-knot": require("../assets/template-previews/generated/wedding/wedding-traditional-knot.png"),
  "wedding-envelope-photo": require("../assets/template-previews/generated/wedding/wedding-envelope-photo.png"),
  "wedding-gold-botanical": require("../assets/template-previews/generated/wedding/wedding-gold-botanical.png"),
  "wedding-illustration-curtain": require("../assets/template-previews/generated/wedding/wedding-illustration-curtain.png"),
  "wedding-botanical-vertical": require("../assets/template-previews/generated/wedding/wedding-botanical-vertical.png"),
  "wedding-photo-overlay": require("../assets/template-previews/generated/wedding/wedding-photo-overlay.png"),
  "wedding-photo-hero": require("../assets/template-previews/generated/wedding/wedding-photo-hero.png"),
  "wedding-green-arch": require("../assets/template-previews/generated/wedding/wedding-green-arch.png"),
...
const bundledTemplateCanvasSource: Record<BundledTemplateCanvasId, ImageSourcePropType> = {
  ...
  "wedding-photo-minimal": require("../assets/template-previews/custom/wedding/wedding-07.png"),
  "wedding-blush-petal": require("../assets/template-previews/custom/wedding/wedding-08.png"),
  "wedding-traditional-knot": require("../assets/template-previews/custom/wedding/wedding-09.png"),
  "wedding-envelope-photo": require("../assets/template-previews/custom/wedding/wedding-10.png"),
  "wedding-gold-botanical": require("../assets/template-previews/custom/wedding/wedding-11.png"),
  "wedding-illustration-curtain": require("../assets/template-previews/custom/wedding/wedding-12.png"),
  "wedding-botanical-vertical": require("../assets/template-previews/custom/wedding/wedding-13.png"),
  "wedding-photo-overlay": require("../assets/template-previews/custom/wedding/wedding-14.png"),
  "wedding-photo-hero": require("../assets/template-previews/custom/wedding/wedding-15.png"),
  "wedding-green-arch": require("../assets/template-previews/custom/wedding/wedding-16.png"),
