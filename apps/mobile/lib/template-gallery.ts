...
export const mobileTemplateGallery: MobileTemplateGalleryItem[] = [
  ...
  { id: "birthday-fun", category: "birthday", name: "언더더씨 파티", badge: "생일파티", desc: "바다 친구들과 함께하는 알록달록 아기 생일파티 카드.", tags: ["#바다", "#동물친구", "#파티"], previewPath: "/images/custom/birthday/birthday-01.jpeg" },
  { id: "birthday-elegant", category: "birthday", name: "샤크 버블", badge: "생일파티", desc: "상어 가족과 바닷속 버블이 가득한 경쾌한 생일파티 카드.", tags: ["#샤크", "#버블", "#블루"], previewPath: "/images/custom/birthday/birthday-02.jpeg" },
  { id: "birthday-kids", category: "birthday", name: "정글 프렌즈", badge: "생일파티", desc: "정글 동물 친구들과 함께하는 탐험 테마 생일파티 카드.", tags: ["#정글", "#동물", "#탐험"], previewPath: "/images/custom/birthday/birthday-03.jpeg" },
