# InviteHub App Store Connect Input Packet - Build 40

Date: 2026-05-03

Use this packet when entering App Store Connect fields for build `1.0.0 (40)`.
...
Select build `1.0.0 (40)` for the App Store version only after the iPhone
...
open-confirmation prompt, dev overlay, or simulator window chrome.
