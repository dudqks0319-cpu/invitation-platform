...
- `SKIP_IOS_RELEASE_BUILD=1 zsh scripts/invitehub-release-gate.sh`:
  ...
  focused 9-file mobile/API test suite with 34 tests. The 65-check App Store
...
- Fast release gate recheck on 2026-05-03 13:24 KST:
  ...
  tests. The new 65-check App Store packet verifier is pinned to build 40.
